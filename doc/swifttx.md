...
This mechanism has been integrated into Bitcore-Node-Cryptodev which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CryptoDevDeveloper/insight-api-cryptodev#web-socket-api](https://github.com/CryptoDevDeveloper/insight-api-cryptodev#web-socket-api) 
* API: [https://github.com/CryptoDevDeveloper/insight-api-cryptodev#swifttx-transactions](https://github.com/CryptoDevDeveloper/insight-api-cryptodev#swifttx-transactions) 
...
By default, the Cryptodev Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cryptodev Core daemon:

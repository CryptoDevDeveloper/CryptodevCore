...
/* Crdvx GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Cryptodev"
#define QAPP_ORG_DOMAIN "cryptodev.tech"
#define QAPP_APP_NAME_DEFAULT "Cryptodev-Qt"
#define QAPP_APP_NAME_TESTNET "Cryptodev-Qt-testnet"
